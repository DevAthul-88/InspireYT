    ...
    return (
        <div className="hero lg:pt-[180px] max-lg:pt-[160px] pb-[100px] overflow-hidden lg:overflow-visible bg-white dark:bg-dark-300 pt-[100px] max-md:py-25 relative max-md:overflow-hidden">
            ...
            <section className="relative">
                <div className="absolute left-1/2 -top-[250px] w-full h-[550px] -translate-x-1/2 bg-cover  bg-no-repeat bg-center opacity-70 md:hidden -z-10" />
                <div className="container ">
                    <div className="relative z-10">
                        ...
                        <div className=" grid grid-cols-3 max-md:grid-cols-1 gap-8">
                            <div
                                className="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5 aos-init aos-animate"
                                data-aos="fade-up"
                                data-aos-offset={200}
                                data-aos-duration={1000}
                                data-aos-once="true"
                            >
                                <div className="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center ">
                                    ...
                                    <p>1234 Imaginary Lane
                                        Fictional City, FX 56789
                                        United States</p>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                <div className="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center">
                                    ...
                                    <a href="devathulvinod@gmail.com"> devathulvinod@gmail.com </a>
                                </div>
                            </div>
                            <div
                                className="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5 aos-init aos-animate"
